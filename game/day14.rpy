...
play music "music/Base.ogg" fadein 6.0
...
show p m:
    linear 0 xalign -0.2 yalign 1.0

play sound "sounds/DoorOpen2.ogg"

e "Nema pops her head out of her door."
...
r m "If you actually wanted us to step up,{w= 0.15} youd've give us a chance."
...
e "Hei turns and storms off back into his room."
...
call blueRoom from _call_blueRoom_22
...
menu:#computer
    "I'll read my emails.":
        ...
        menu:
            "Haruka's summary.":
                call day14HaruS from _call_day14HaruS
                jump summariesD14
                pass
            "Hei's summary.":
                call day14HeiS from _call_day14HeiS
                jump summariesD14
                pass
            "Nema's summary.":
                call day14NemaS from _call_day14NemaS
                jump summariesD14
                pass
            "Email from Nema." if nemaPoem:
                call nemaMailD14 from _call_nemaMailD14
                jump summariesD14
                pass
            "Junk mail.":
                call bMail11 from _call_bMail11
                jump summariesD14
                pass
            "I think I'm done.":
                jump day14Mid
