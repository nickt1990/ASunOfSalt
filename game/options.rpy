...
define config.name = _("A Sun Of Salt")
...
define config.main_menu_music = "music/ASoS Theme.ogg"
...
define config.window_show_transition = Dissolve(.17)
define config.window_hide_transition = Dissolve(.17)
...
define config.save_directory = "ASunOfSalt-1512004812"
...
init python:
    ...
    build.classify('game/images/Hei/**.psd', 'archive')    
    build.classify('game/images/Nema/**.png', 'archive')
    build.classify('game/images/Nema/**.psd', 'archive')
    build.classify('game/gui/**.psd', 'archive')
