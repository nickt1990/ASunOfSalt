...
#label start:
    ...
    #play voice "harukaHi.mp3"
    #stop sound
    #stop music fadeout 1.0
    #queue sound "woof.ogg"
    #queue music [ "a.ogg", "b.ogg" ]
    #play audio [ "<silence .5>", "boom.opus" ]
    $ renpy.music_start('music/ASOS Base.mp3')
    ...
    #show hei hap at right
    
    #show nema animated at left
    
    #show hei animated at right
    
    #show nema hap at left
    ...
    show haruka animated
    y "Things have changed as you can probably see."
    ...
    show nema animated at left with dissolve
    
    p "Yeah, I guess it does look different..."

    y "I don't think it's so bad do you?"
    ...
    show haruka mad anim
    
    y "Geez, yes?"
    
    
    p "What exactly is different... again?"
...
#        parallel:
#            xalign 0.5
#            linear 1.2 xalign .504
#            linear .9 xalign .5
#            linear 1.3 xalign .496
#            linear .9 xalign .5
#            repeat
#        parallel:
#            yalign 0.5
#            linear 1 yalign 0.504
#            linear .8 yalign 0.5
#            linear 1.2 yalign 0.496
#            linear 1 yalign 0.5            
#            repeat
            
    
    y "I can tell you about the features of Ren'Py games, or how to write
...
label writing:
    ...
    # have to reshow the nema hap image, so that it appears that
...
init:
    ...
    image eileen animated = Animation(
        "Haruka_Naked_Happy.png", 10.0,
        "Haruka_Naked_Sad", 0.5)
...
label demonstrate:
    ...
    menu demo_menu:
        ...
        "Positions and movement, updated in 4.8.":
            ...
            show nema hap at offscreenleft with move
            ...
            show nema hap at center with move

            e "I can also move to the center..."

            show nema hap at right with move

            e "... the right ..."

            show nema hap at offscreenright with move
            ...
            show nema hap at Move((1.0, 1.0, 'right', 'bottom'),
                                      (0.0, 1.0, 'left', 'bottom'),
